...
/** Email-only sign-in: requests a one-time link instead of routing through a third-party OAuth flow. */
export default function MagicLinkLogin({ locale, next, labels }: MagicLinkLoginProps) {
